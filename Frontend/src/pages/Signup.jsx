    ...
    return (
      <div>
        ...
        <div className='lg:flex'>
          <div className='lg:w-1/2 xl:max-w-screen-sm'>
            <div className='py-12 bg-purple-100 lg:bg-white flex justify-center lg:justify-start lg:px-12 dark:bg-[#121212]'>
              <div className='cursor-pointer flex items-center'>
                <div className='text-2xl text-purple-800 tracking-wide ml-2 font-semibold'></div>
              </div>
            </div>
            <div className='mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl'>
              <h2
                className='text-center text-4xl text-purple-900 font-display font-semibold lg:text-left xl:text-5xl dark:text-white
                    xl:text-bold'
              >
                Sign Up
              </h2>
          ...
          <div className='hidden lg:flex items-center justify-center border-r-16 bg-purple-100 flex-1 h-[calc(100vh_-_5rem)] dark:bg-[#393E46]'>
